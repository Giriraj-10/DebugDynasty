-- ==========================================
-- IntelliCare Schema Definition
-- Compatible with PostgreSQL, MySQL and H2
-- ==========================================

-- 1. Base Users Table (Synchronized with Firebase Authentication UID)
CREATE TABLE IF NOT EXISTS users (
    firebase_uid VARCHAR(255) PRIMARY KEY,
    email VARCHAR(255) UNIQUE NOT NULL,
    role VARCHAR(50) NOT NULL, -- PATIENT, DOCTOR, HOSPITAL, AMBULANCE, BLOOD_BANK
...
-- 5. Ambulance Providers Profile Table
